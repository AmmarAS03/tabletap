      ...
      <div className="min-h-screen bg-[#f1f1f1] px-4 py-8 text-[#3a855d]">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <header className="text-center">
            ...
            <p className="text-[#3a855d]/80">Please browse the menu and place your order.</p>
          </header>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-[#3a855d]/20">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-[#3a855d]/70">Toasted with herbs and butter</p>
                    </div>
                    <div className="text-right">
                      <p className="font-medium">$4.00</p>
                      <button className="mt-1 text-sm text-[#3a855d] hover:underline">Add</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-[#3a855d]/20">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-[#3a855d]/70">Crispy rolls with veggies</p>
                    </div>
                    <div className="text-right">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-[#3a855d]/20">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-[#3a855d]/70">Refreshing and cool</p>
                    </div>
                    <div className="text-right">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-[#3a855d]/20">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-[#3a855d]/70">Freshly squeezed</p>
                    </div>
                    <div className="text-right">
